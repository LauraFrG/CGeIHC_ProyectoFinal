...
/* ----------------   Práctica 7 --------------------------*/
/*-----------------    2019-2   ---------------------------*/
/*------------- Alumno:Fragoso Gasca Ana Laura ---------------*/
/*-------------Visual Studio+ 2017 ----------------------*/
#include "esfera.h"
#include "camera.h"
...
void display(void)
{
	...
	projectionShader.setVec3("diffuseColor", 1.0f, 0.7f, 0.4f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.5f, 1.0f, 0.7f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	model = glm::rotate(model, glm::radians(tierra * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.9f, 0.3f, 0.3f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Luna Marte 1
	model = glm::rotate(model, glm::radians(marte * 3), glm::vec3(0.0f, 1.0f, 1.0f));
	model = glm::translate(model, glm::vec3(0.3, 0, 0));
	model = glm::rotate(model, glm::radians(marte * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	...
	//Luna Marte 2
	model = glm::rotate(model, glm::radians(marte * 2), glm::vec3(1.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.3, 0, 0));
	model = glm::rotate(model, glm::radians(marte * 1), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.03f, 0.03f, 0.03f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.9f, 0.7f, 0.2f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Luna Jupiter 1
	model = glm::rotate(model, glm::radians(jupiter * 3), glm::vec3(0.0f, 0.0f, 1.0f));
	model = glm::translate(model, glm::vec3(0.72, 0, 0));
	model = glm::rotate(model, glm::radians(jupiter * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.04f, 0.04f, 0.04f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.85f, 0.85f, 0.85f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Luna Jupiter 2
	model = glm::rotate(model, glm::radians(jupiter * 4), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.74, 0, 0));
	model = glm::rotate(model, glm::radians(jupiter * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.04f, 0.04f, 0.04f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.95f, 0.95f, 0.95f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Luna Jupiter 3
	model = glm::rotate(model, glm::radians(jupiter * 2), glm::vec3(1.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.76, 0, 0));
	model = glm::rotate(model, glm::radians(jupiter * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.04f, 0.04f, 0.04f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	...
	//Luna Jupiter 4
	model = glm::rotate(model, glm::radians(jupiter * 3), glm::vec3(1.0f, 1.0f, 1.0f));
	model = glm::translate(model, glm::vec3(0.78, 0, 0));
	model = glm::rotate(model, glm::radians(jupiter * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.04f, 0.04f, 0.04f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.2f, 0.9f, 0.8f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Anillo Saturno 1
	model = glm::rotate(model, glm::radians(saturno * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.9f, 0.01f, 0.9f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.5f, 0.5f, 0.85f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Anillo Saturno 2
	model = glm::rotate(model, glm::radians(saturno * 2), glm::vec3(1.0f, 1.0f, 0.0f));
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.7f, 0.7f, 0.9f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();	//Sphere
	...
	//Luna Urano 1
	model = glm::rotate(model, glm::radians(urano * 3), glm::vec3(0.0f, 1.0f, 1.0f));
	model = glm::translate(model, glm::vec3(0.3, 0, 0));
	model = glm::rotate(model, glm::radians(urano * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.03f, 0.03f, 0.03f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.6f, 0.6f, 0.6f);
	...
	//Luna Urano 2
	model = glm::rotate(model, glm::radians(urano * 2), glm::vec3(1.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.3, 0, 0));
	model = glm::rotate(model, glm::radians(urano * 1), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.03f, 0.03f, 0.03f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.7f, 0.7f, 0.7f);
	...
	//Luna Neptuno
	model = glm::rotate(model, glm::radians(neptuno * 3), glm::vec3(1.0f, 1.0f, 1.0f));
	model = glm::translate(model, glm::vec3(1.5, 0, 0));
	model = glm::rotate(model, glm::radians(neptuno * 2), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 1.0f, 1.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
